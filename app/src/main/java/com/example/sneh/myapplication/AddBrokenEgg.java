...
public class AddBrokenEgg extends AppCompatActivity {
    ...
    int building_id,cicle_id,egg_id;
    int type_ = 99;
    int type_other = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_broken_egg);
        ...
        egg_b egg=handler.getBrokenEgg(egg_id);
        ...
        if(egg_id!=-1){
            ...
            egg_sql=egg.getSql_broken_egg_id();
        }
        Log.d("Add_B_egg_egg_id", String.valueOf(egg_id));
        Log.d("Add_B_egg_cicle_id", String.valueOf(cicle_id));
        Log.d("Add_B_egg_build_id",String.valueOf(building_id));
        Log.d("Add_B_egg_cicle_sql",String.valueOf(cicle_sql));
        Log.d("Add_B_egg_build_sql",String.valueOf(building_sql));
        Log.d("Add_B_egg_egg_sql",String.valueOf(egg_sql));
        Log.d("Add_B_egg_user_id",String.valueOf(user_id));
        Log.d("Add_B_egg_egg_flag",String.valueOf(sql_flag));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(type.getSelectedItemPosition() == 0 || date.getText().toString().isEmpty() || number.getText().toString().isEmpty() || other_string.isEmpty())
                    Toast.makeText(AddBrokenEgg.this, getResources().getString(R.string.fill_all_fields), Toast.LENGTH_SHORT).show();
                else {
                    if (egg_id != -1) {
                        egg_b egg = new egg_b();
                        egg.setSql_broken_egg_id(egg_sql);
                        ...
                        Log.d("add_be_update_flag",String.valueOf(egg.getFlag()));
                        handler.updateBrokenEgg(egg);
